...
from model.optimize import optimize_w, copy_model_params
...
for epoch in range(1, args.epochs + 1):
    ...
    for mm in tqdm(mm_data_loader, unit='batch'):
        ...
        mm_loss_first = model(mm)
        loss_list_mm.append(mm_loss_first.item())
        ...
        model = optimize_w(
            ...
            update_linear_lr=args.update_linear_lr,
            update_embedding_lr=args.update_embedding_lr
        )

        mm_loss_second = model(mm, second_forward=True)
    ...
    if recall_text > best_recall_text:
        ...
        # save_path = '/home/data1/MSD/text.pt'
    ...
    if f1_score_image > best_f1_image:
        ...
        # save_path = '/home/data1/MSD/image.pt'
        # torch.save(model.state_dict(), save_path)
    ...
    if f1_score_mm > best_f1_mm:
        ...
        # save_path = /home/data1/MSD/mm.pt
        # torch.save(model.state_dict(), save_path)
